...
HD_PWD='/home/s3310914/Documents/eca1/fifo_dma/fifo_dma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convoluter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convoluter.tcl
