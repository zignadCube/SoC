...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/s3310914/Documents/eca1/DMA/DMA.cache/compile_simlib/vcs"
  fi
