...
simulate()
{
  xsim Main -key {Behavioral:sim_1:Functional:Main} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d575.protoinst" -protoinst "protoinst_files/Main.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/remote/labware/packages/xilinx/vivado/2023.1/data/xsim"
  fi
