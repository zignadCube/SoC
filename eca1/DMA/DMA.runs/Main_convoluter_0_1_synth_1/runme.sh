...
HD_PWD='/home/s3310914/Documents/eca1/DMA/DMA.runs/Main_convoluter_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_convoluter_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_convoluter_0_1.tcl
