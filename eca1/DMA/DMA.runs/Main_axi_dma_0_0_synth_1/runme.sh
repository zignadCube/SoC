...
HD_PWD='/home/s3310914/Documents/eca1/DMA/DMA.runs/Main_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_axi_dma_0_0.tcl
